...
public class SignPage extends BrowserDriver {
    public static String username_text_xpath = "//*[@id=\"usr\"]";
    public static String password_text_xpath = "//*[@id=\"pwd\"]";
    public static String login_btn_xpath = "//*[@id=\"second_form\"]/font/font/input";
    public static String registration_btn_xpath = "//*[@id=\"NewRegistration\"]";

    public static void sendKeys_username(){
        driver.findElement(By.xpath(username_text_xpath)).sendKeys("jjujuju");
    }

    public static void sendKeys_password(){
        driver.findElement(By.xpath(password_text_xpath)).sendKeys("jjujuju");
    }
